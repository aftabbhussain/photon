...
import {FileReceiver} from './workers/fileReciever.js';
    ...
    <div style={{padding:32,fontFamily:'monospace',background:'#0a0a0c',color:'#38bdf8',minHeight:'100vh'}}>
      ...
      <div style={{borderTop:'1px dashed #333',paddingTop:20}}>
        ...
        <input
          ...
          style={{marginBottom:16,display:'block',color:'#fff'}}
        />

        <button
          onClick={handleFileTransferStream}
          disabled={!activeChannel||!stagedFile}
          style={{background:activeChannel&&stagedFile?'#db2777':'#374151',color:'#fff',border:0,padding:'14px 28px',borderRadius:4,cursor:activeChannel&&stagedFile?'pointer':'not-allowed',fontSize:'1rem',fontWeight:'bold'}}
        >
